...
class Dashboard extends React.Component {
  constructor(props) {
    ...
    this.socket = socketIO(
      "https://secure-chatweb.7e14.starter-us-west-2.openshiftapps.com/"
    );
      ...
      <div>
        {this.props.rooms.map((room, i) => {
          ...
          return (
            ...
            >
              {mainListItems(room, this.props.loginReducer.username)}
            </span>
          );
        })}
      </div>
  ...
  displayChatUser() {
    if (
      this.props.selectedRoom.selected.owner &&
      ...
      if (
        this.props.loginReducer.username ===
        this.props.selectedRoom.selected.owner.username
      ) {
    ...
    return (
      <div className={classes.root}>
        ...
        >
          ...
          <Divider />
          <List className={classes.dashboardList}>{this.renderUserList()}</List>
          <Divider />
        ...
        <main className={classes.content}>
          ...
          <Typography component="div" className={classes.chartContainer}>
            {this.state.selected ? (
              <Chatroom room={this.state.selected} />
            ) : null}
          </Typography>
        </main>
      </div>
